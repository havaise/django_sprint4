...
class CommDeleteView(LoginRequiredMixin, EditCommMixin, DeleteView):
    pass
...
class UserDetailsView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['page_obj'] = pag_posts(posts, self.request)
        return context


class CategoryListsView(PostsListsMixin, ListView):
...
class UserUpdView(LoginRequiredMixin, UpdateView):
    model = get_user_model()
...
class PostDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if self.request.user.is_authenticated:
            context['form'] = CommForm()
        return context


class CommCreateView(LoginRequiredMixin, CommMixin, CreateView):
...
class CommUpdateView(LoginRequiredMixin, EditCommMixin, UpdateView):
    pass
...
def pag_posts(posts, request, per_page=10):
